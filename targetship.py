...
def draw():
    global items, curent_level, game_over, game_complete
    screen.clear()
...
def layout_items(items_to_layout):
    ...
    random_shuffle(items_to_layout)
...
def animate_items(items_to_animate):
    ...
    for item in items_to_animate:
        ...
        animation = animate(item, duration = duration, on_finished = handle_gamee_over, y = HEIGHT)
        animations.append(animation)

def handle_gamee_over():
    global game_over
    game_over = True
